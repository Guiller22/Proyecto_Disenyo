...
$base="proyecto_guille";

# establecemos la conexión con el servidor

$conexion=mysqli_connect ("localhost","guille","VaQ2201!",$base);
...
$resultado=mysqli_query($conexion,"SELECT demo4.DNI,demo4.Nombre,demo4.Apellido1,demo4.Apellido2,demodat3.Puntos FROM demo4,demodat2 WHERE (demo4.DNI=demodat2.DNI) ");
