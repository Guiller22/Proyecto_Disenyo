...
# ahora dos bucles anidados (rojo uno, magenta el otro) # para rellenar las celdas de cada fila (el magenta) # y para insertar las etiquetas <TR> utilizaremos el rojo
for ($i=0;$i<5;$i++){        
    print("<tr>");         
    for($j=0;$j<5;$j++) {                        
        print("<td>".$a[$i][$j]."</td>");         
